...
class RiderPaymentView extends StatefulWidget {
  const RiderPaymentView({super.key,required this.paymentUrl});
  final String paymentUrl;
  @override
  State<RiderPaymentView> createState() => _RiderPaymentViewState();
}
