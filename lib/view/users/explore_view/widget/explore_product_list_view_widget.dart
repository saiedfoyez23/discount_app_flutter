...
class ExploreProductListViewWidget extends GetxController {
  ...
  ExploreProductListViewWidget({required this.context});
  ...
  void onInit() {
    ...
    Future.delayed(Duration(seconds: 1),() async {
      await ExploreProductListViewController.getCategoriesApiService(
        onSuccess: (e) {
  ...
  Widget exploreProductListViewWidget({required BuildContext context}) {
    return Container(
