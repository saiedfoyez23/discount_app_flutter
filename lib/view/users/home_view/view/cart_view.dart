                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextHelperClass.headingTextWithoutWidth(
                                      context: context,
                                      text: "Rs ${cartController.getAllProductCartResponse.value.data?.totalShippingFee.toString() ?? "0"}",
                                      fontSize: 16,
                                      fontWeight: FontWeight.w500,
                                      textColor: Color(0xfffefeff),
                                      alignment: Alignment.centerRight,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextHelperClass.headingTextWithoutWidth(
                                      context: context,
                                      text: "Rs ${double.parse(cartController.getAllProductCartResponse.value.data?.totalShippingFee.toString() ?? "0") + double.parse(cartController.subTotal.value.toString())}",
                                      fontSize: 20,
                                      fontWeight: FontWeight.w700,
                                      textColor: Color(0xfffefeff),
                                      alignment: Alignment.centerRight,
