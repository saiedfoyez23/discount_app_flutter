...
class UserDashboardView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final DashboardUserController dashboardUserController = Get.put(DashboardUserController(
      index: index,
                ...
                children: [
                  ...
                  ClipPath(
                    clipper: UserNotchedNavBarClipper(
                      notchCenter: dashboardUserController.notchX.value,
                      context: context,
                    ),
                    child: Container(
                      height: 75.h(context),
                  ...
                  AnimatedPositioned(
                    ...
                    top: -6.h(context),
                    left: dashboardUserController.notchX.value - (5.w(context)),
                    child: Container(
                      width: 10.w(context),
                      height: 10.w(context),
                  ...
                  Row(
                    children: List.generate(dashboardUserController.items.length, (index) {
                      ...
                      return Expanded(
                        child: InkWell(
                          onTap: () {
                            dashboardUserController.changeIndex(index: index, width: width);
                          },
                          child: Column(
...
class UserNotchedNavBarClipper extends CustomClipper<Path> {
  final double notchCenter;
  final BuildContext context;

  UserNotchedNavBarClipper({
